    ...
    public class StudentService : IStudentService
    {
        ...
        public async Task<IEnumerable<Student>> GetStudentbyName(string studentName)
        {
            ...
            if (query != null)
            {
                ...
                {
                    query = query.Where(e => e.StudentName.Contains(studentName));
        ...
        public async Task<bool> UpdateStudent(string studentId, UpdateStudentRequest updateStudent)
        {
            ...
            if (student != null)
            {
                student.StudentName = string.IsNullOrWhiteSpace(updateStudent.StudentName) ? student.StudentName : updateStudent.StudentName;
