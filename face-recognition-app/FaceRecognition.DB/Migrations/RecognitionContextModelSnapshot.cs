...
namespace FaceRecognition.DB.Migrations
{
    ...
    partial class RecognitionContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FaceRecognition.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FaceRecognition.Models.Parent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FaceRecognition.Models.Parent", b =>
                {
                    ...
                    b.HasOne("FaceRecognition.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FaceRecognition.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
